    ...
    private void initParticles(){
        ...
        foreach(var v in vertices){
            ...
            ***/
            ...
            p.contactSpring = cS;
            p.attachedToContact = Vector3.Dot(p.position - cS.attachPoint, plane.normal) < 0.0;
    ...
    private void resetParticleForces(){
        ...
        ***/
        ...
        for(int i = 0; i < n; i++){
            ...
            // if d < 0, there is a collision; if d > 0, there is no ground collision
            curr_particle.attachedToContact = (d < 0); 
            
            if(curr_particle.attachedToContact){ // (x_p-x_g)dot n < 0
